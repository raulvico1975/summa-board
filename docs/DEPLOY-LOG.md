...
2026-04-01
Premium public web deployed manually from local branch codex/premium-public-web.
Deployed commit: 0eedc873 marketing(web): refine premium public site
Public web scope:
- premium home aligned to governance + AI minutes positioning
- canonical SEO landings active for actes amb IA, juntes directives and convocatories i votacions
- alias routes redirecting to canonical landings
- robots.txt and sitemap.xml active
- login/signup kept out of index
Deploy command:
- npx -y firebase-tools@latest deploy --only hosting
Runtime result:
- SSR function updated successfully: firebase-frameworks-summa-board:ssrsummaboard (europe-west1)
- Hosting release completed for summa-board
Validation:
- https://summareu.app/ca returned 200 after release
- deployed frontend kept security headers and middleware locale redirect behavior
- local mobile validation confirmed no horizontal overflow on home and canonical landing
