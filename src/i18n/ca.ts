export const ca = {
  ...
  poll: {
    ...
    deleteVoteError: "No s'ha pogut esborrar el vot.",
  ...
  meeting: {
    ...
    processingErrorAction:
      "El resultat final encara no està disponible. Revisa la configuració de Daily i de la reunió abans de continuar.",
  ...
  settings: {
    ...
    orgNameError: "No s'ha pogut actualitzar el nom.",
    ...
    languageError: "No s'ha pogut actualitzar l'idioma.",
  ...
  errors: {
    ...
    voteNotFound: "No s'ha trobat el vot.",
