...
export const esExtra: DeepPartial<I18nCa> = {
  ...
  poll: {
    ...
    deleteVoteError: "No se ha podido borrar el voto.",
  ...
  settings: {
    ...
    orgNameError: "No se ha podido actualizar el nombre.",
    ...
    languageError: "No se ha podido actualizar el idioma.",
    ...
    deleteError: "No se ha podido eliminar la cuenta.",
  },
  meeting: {
    title: "Reunión",
